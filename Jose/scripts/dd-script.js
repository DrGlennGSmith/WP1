...
draggableElements.forEach(elem => {
  // Start when the user starts dragging an item
...
// variable to find the end of the game
var totalElements = elementIdsShuffled.length;
...
function drop(event) {
  ...
  if(isCorrectMatching) {
    ...
    totalElements -= 1;
      if (totalElements == 0){
        alert(`Well done, you only had ${mistakes} errors!!`);
      }
  } else {
